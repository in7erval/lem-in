...
void	push_back_room(t_room **head, t_room *room) // Добавляет в конец списка новую комнату
{
	t_room *buf;
...
void	add_union(t_room *rooms, char *room1_name, char *room2_name) // Добавляет связь между комнатами
{
	t_room *room1;
	t_room *room2;
